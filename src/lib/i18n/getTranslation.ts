...
// Defines a function type that takes a key of type ObjectKeys from TranslationObject and returns a string.
...
/**
 * Retrieves the translation function and returns a translation for a specified key.
 *
