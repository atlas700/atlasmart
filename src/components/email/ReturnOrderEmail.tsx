      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            We have received your request to return the following items, and the
          ...
          <Text style={paragraph}>
            ...
            Thank you for choosing 🛍 AtlasMart.
          </Text>
...
export const ReturnOrderEmailHtml = (props: EmailTemplateProps) => {
